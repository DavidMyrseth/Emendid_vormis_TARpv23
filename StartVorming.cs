namespace Emendid_vormis_TARpv23
{
    public partial class StartVorming : Form
    {
        ...
        public StartVorming()
        {
            ...
            TreeNode tn = new TreeNode("Elemndid: ");
            ...
            // silt-button
            lbl = new Label();
            lbl.Text = "Aknade elemndid c# abil";
            ...
            pbox.Image = Image.FromFile(@"..\..\..\untitled.jpg");
        ...
        {
            string[] pildid = { "untitled.jpg", "dd.jpeg", "drftgyhu.jpg" };
        ...
        private void Tree_AfterSelect(object? sender, TreeViewEventArgs e)
        {
            ...
            { 
                ...
                chk2 = new CheckBox();
                chk2.Checked = false;
                chk2.Image = Image.FromFile(@"..\..\..\untitled.jpg");
